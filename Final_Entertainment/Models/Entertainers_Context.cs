...
{
    public partial class Entertainers_Context : DbContext
    {
        public Entertainers_Context()
        {
        }

        public Entertainers_Context(DbContextOptions<Entertainers_Context> options)
            : base(options)
        {
        }
